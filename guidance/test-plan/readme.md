The IEEE 829 test plan contains too much superfluous information (typical IEEE standard document).  You can get some testing concepts from it and the included example, but don't use it as a template.
